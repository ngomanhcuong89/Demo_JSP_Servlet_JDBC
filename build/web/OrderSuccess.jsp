...
<html>
    ...
    <body>
        ...
        <div class="container" style="margin-top: 20px">
            ...
            <div class="container breadcrumb">
                <a href="showproduct"><input type="submit" name="back" class="btn-success" style="margin-right: 10px" value="Quay Lại Trang Chủ"/></a>
                <a href="#"><input type="submit" name="vieworder" class="btn-success" value="Xem Tình Trạng Đơn Hàng"/></a>
            </div>                
        </div>
        <!-- footer -->
